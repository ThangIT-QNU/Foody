...
<body class="px-5" style="background-color:#F5F5F5; font-family: 'Times New Roman', Times, serif;">
    <div>
        ...
        <div>
            <div class="mt-1">
                <h3 class="text-center"><b>TẤT CẢ</b></h3>
            ...
            <div class="text-center mt-4">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item"><a class="page-link" href="http://localhost/Foody/index.php?page=1">Trang
                                đầu</a></li>
                        <?php
                        ...
                        <li class="page-item"><a class="page-link"
                                href="http://localhost/Foody/index.php?page=<?= $num ?>"><?= $num ?></a>
                        </li>
                        <?php
                                }
                            } else {
                        ...
                        <li class="page-item"><a class="page-link"
                                href="http://localhost/Foody/index.php?page=<?= $allPage ?>">Trang
                                cuối</a></li>
                    </ul>
                </nav>
            </div>
