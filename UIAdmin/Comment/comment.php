            ...
            <ul class="nav">
                <li class="nav-item align-self-center">
                    <a href="http://localhost/Foody/index.php">
                        <img height="50px" width="120px" src="../../Asset/Image/now.jpg">
                    </a>
                </li>
                <li class="nav-item align-self-center">
                ...
                <table class="table table-striped text-center">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?= $row['hinhAnh'] ?></td>
                            ...
                            <td class="align-middle" style="width: 150px;">
                                <a href="http://localhost/Foody/UIAdmin/Account/updateAccount.php?idDanhGia=<?= $row['idDanhGia'] ?>"
