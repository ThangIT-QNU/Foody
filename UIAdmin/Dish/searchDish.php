...
<body class="px-5" style=" background-color:#F5F5F5; font-family: 'Times New Roman', Times, serif;">
    <div class="container">
        ...
        <div class="container">
            <h4 class="text-center">ADMINS - SEARCH DISH</h4>
            <div>
            </div>
            <div class="mt-2">
                ...
                <div class="scrollTable " id="fixScroll">
                    <table class="table table-striped text-center">
                        <tbody>
                            ...
                            $allDong = mysqli_query($conn, "SELECT * FROM loaimonan, monan WHERE loaimonan.idLoaiMonAn = monan.idLoaiMonAn AND tenMonAn LIKE '%$keySearch%'")->num_rows;
                            $allPage = ceil($allDong / $soDongHT);
                            $sql = "SELECT * FROM loaimonan, monan WHERE loaimonan.idLoaiMonAn = monan.idLoaiMonAn AND tenMonAn LIKE '%$keySearch%' LIMIT $soDongHT OFFSET $pageTT";
                            $query = mysqli_query($conn, $sql);
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Foody/UIAdmin/Dish/searchDish.php?key=<?= $keySearch ?>&page=1">Trang
                                    đầu</a></li>
                            <?php
                            ...
                            ?>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Foody/UIAdmin/Dish/searchDish.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?><a>
                            </li>
                            <?php
                                    }
                                } else {
                            ...
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Foody/UIAdmin/Dish/searchDish.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                                    cuối</a></li>
                        </ul>
                    </nav>
                </div>
