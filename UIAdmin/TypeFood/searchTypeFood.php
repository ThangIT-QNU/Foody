...
<body class="px-5" style=" background-color:#F5F5F5; font-family: 'Times New Roman', Times, serif;">
    <div class="container">
        ...
        <div class="container">
            <h4 class="text-center"><b>ADMINS - SEARCH TYPE FOOD</b></h4>
            <div>
            </div>
            <div class="mt-2">
                    ...
                    <table class="table table-striped text-center">
                        <tbody>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">ADD TYPE FOOD</h5>
                                                </div>
                                                <form method="POST">
                                                    <div class="modal-body text-left  ">
                                                        <label for="txtLoaiMon">LOẠI MÓN</label>
                                                        <input type="text" class="form-control" id="txtLoaiMonAn"
                                                            name="txtLoaiMonAn" placeholder="Enter LOẠI MÓN">
                                                    </div>
                                                ...
                                                <?php
                                                    ...
                                                    $txtLoaiMon = $_POST['txtLoaiMonAn'];
                                                    //
                                                    $sql = "INSERT INTO loaimonan(tenLoaiMonAn) VALUES('$txtLoaiMonAn')";
                            ...
                            <?php
                                ...
                                $allDong = mysqli_query($conn, "SELECT * FROM loaimonan WHERE tenLoaiMonAn LIKE '%$keySearch%'")->num_rows;
                                $allPage = ceil($allDong / $soDongHT);
                                //
                                $sql = "SELECT * FROM loaimonan WHERE tenLoaiMonAn LIKE '%$keySearch%' LIMIT $soDongHT OFFSET $pageTT";
                                $query = mysqli_query($conn, $sql);
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Foody/UIAdmin/TypeFood/searchTypeFood.php?key=<?= $keySearch ?>&page=1">Trang
                                    đầu</a></li>
                            <?php
                            ...
                            ?>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Foody/UIAdmin/TypeFood/searchTypeFood.php?key=<?= $keySearch ?>&page=<?= $num ?>"><?= $num ?></a>
                            </li>
                            <?php
                                    }
                                } else {
                            ...
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Foody/UIAdmin/TypeFood/searchTypeFood.php?key=<?= $keySearch ?>&page=<?= $allPage ?>">Trang
                                    cuối</a></li>
                        </ul>
                    </nav>
                </div>
