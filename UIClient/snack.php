...
<body class="px-5" style="background-color:#F5F5F5; font-family: 'Times New Roman', Times, serif;">
    <div>
        ...
        <div>
            <div class="mt-1"><br />
                <h3 class="text-center"><b>ĐỒ ĂN VẶT</b></h3>
                <div class="d-flex flex-wrap justify-content-center">
                    <?php
                        ...
                        $allDong = mysqli_query($conn, "SELECT * FROM monan,loaimonan WHERE monan.idLoaiMonAn = loaimonan.idLoaiMonAn AND loaimonan.idLoaiMonAn = '3'")->num_rows;
                        $allPage = ceil($allDong / $soDongHT);
                        $sql = "SELECT * FROM monan,loaimonan WHERE monan.idLoaiMonAn = loaimonan.idLoaiMonAn AND loaimonan.idLoaiMonAn = '3' LIMIT $soDongHT OFFSET $pageTT";
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item"><a class="page-link"
                                href="http://localhost/Foody/UIClient/snack.php?page=1">Trang đầu</a></li>
                        <?php
                        ...
                        ?>
                        <li class="page-item"><a class="page-link"
                                href="http://localhost/Foody/UIClient/snack.php?page=<?= $num ?>"><?= $num ?></a>
                        </li>
                        <?php
                                }
                            } else {
                        ...
                        <li class="page-item"><a class="page-link"
                                href="http://localhost/Foody/UIClient/snack.php?page=<?= $allPage ?>">Trang
                                cuối</a></li>
                    </ul>
                </nav>
            </div>
