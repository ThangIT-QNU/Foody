...
<body class="px-5" style="background-color:#F5F5F5; font-family: 'Times New Roman', Times, serif;">
    <div>
        ...
        <div>
            <div class="mt-1"><br />
                <h3 class="text-center"><b>ĐỒ HẢI SẢN</b></h3>
                <div class="d-flex flex-wrap justify-content-center">
                    ...
                    $allDong = mysqli_query($conn, "SELECT * FROM monan,loaimonan WHERE monan.idLoaiMonAn = loaimonan.idLoaiMonAn AND loaimonan.idLoaiMonAn = '2'")->num_rows;
                    $allPage = ceil($allDong / $soDongHT);
                    $sql = "SELECT * FROM monan,loaimonan WHERE monan.idLoaiMonAn = loaimonan.idLoaiMonAn AND loaimonan.idLoaiMonAn = '2' LIMIT $soDongHT OFFSET $pageTT";
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div style="color: #50685e;">
                                    <b>Thể loại: &nbsp;</b><span><?= $row['tenLoaiMonAn'] ?></span><br>
